    ...
    <>
      ...
      {!isMobile && (
        <tr
          ...
          className="hidden md:table-row hover:bg-gray-50 dark:hover:bg-white/10 transition-colors"
        >
          <td className="px-4 py-6 align-middle">
            <div className="flex gap-2 items-center">
              ...
              >
                <div>
                  <p className="text-center dark:text-text-primary-darkMode">
                    {user.fullName[0]}
                  </p>
                  <span
              ...
              <div>
                ...
                >
                  <p className="text-body  font-bold dark:text-text-primary-darkMode">
                    {user.fullName}
                  </p>
      ...
      {isMobile && (
        <div className="md:hidden userStats-card mb-3">
          <div className="flex gap-2 items-center">
            ...
            >
              <div>
                <p className="text-center font-bold dark:text-text-primary-darkMode">
                  {user.fullName[0]}
                </p>
                <span
          ...
          <div className="flex gap-2 mt-3 w-full">
            <Buttons
              ...
              more="justify-center hover:bg-black/5 dark:hover:bg-white/10 hover:border-black/70 dark:hover:border-white/70"
            >
              View
            </Buttons>
            <Buttons
