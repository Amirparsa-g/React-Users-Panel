...
const AboutPage = () => {
  ...
  return (
    <>
      <h2 className="text-header2 font-bold w-full ">{t("pages.about.title")}</h2>
      <p className="caption w-full mb-7">{t("pages.about.subtitle")}</p>

      <div className="flex flex-col userStats-card">
        <h2 className="text-bodyHeader font-bold">{t("pages.about.purpose")}</h2>
        <p className="text-text-secondary">{t("pages.about.purposeText")}</p>
        <br />
        <h2 className="text-bodyHeader font-bold mb-3">{t("pages.about.features")}</h2>
        ...
        <h2 className="text-bodyHeader font-bold my-3">{t("pages.about.stageFocus")}</h2>
